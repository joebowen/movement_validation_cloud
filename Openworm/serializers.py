...
class ExperimenterSerializer(serializers.ModelSerializer):
    #owner = serializers.SlugRelatedField(queryset=User.objects.all(), many=True, slug_field='name')
    labkey = serializers.SlugRelatedField(queryset=Lab.objects.all(), many=True, slug_field='name')
...
class FeaturesperplatewireframeSerializer(serializers.ModelSerializer):
    #owner = serializers.SlugRelatedField(queryset=User.objects.all(), many=True, slug_field='name')
    platefeaturekey = serializers.SlugRelatedField(queryset=Platefeature.objects.all(), many=True, slug_field='name')
    platewireframevideokey = serializers.SlugRelatedField(queryset=Platewireframevideo.objects.all(), many=True, slug_field='name')
...
class FeaturesperwormwireframeSerializer(serializers.ModelSerializer):
    #owner = serializers.SlugRelatedField(queryset=User.objects.all(), many=True, slug_field='name')
    wormfeaturekey = serializers.SlugRelatedField(queryset=Wormfeature.objects.all(), many=True, slug_field='name')
    wormwireframekey = serializers.SlugRelatedField(queryset=Wormwireframevideo.objects.all(), many=True, slug_field='name')
...
class HistogramsperwormwireframeSerializer(serializers.ModelSerializer):
    #owner = serializers.SlugRelatedField(queryset=User.objects.all(), many=True, slug_field='name')
    directionkey = serializers.SlugRelatedField(queryset=Direction.objects.all(), many=True, slug_field='name')
    wormfeaturekey = serializers.SlugRelatedField(queryset=Wormfeature.objects.all(), many=True, slug_field='name')
    wormwireframekey = serializers.SlugRelatedField(queryset=Wormwireframevideo.objects.all(), many=True, slug_field='name')
    signkey = serializers.SlugRelatedField(queryset=Sign.objects.all(), many=True, slug_field='name')
...
class MeasurementsperwormwireframeSerializer(serializers.ModelSerializer):
    #owner = serializers.SlugRelatedField(queryset=User.objects.all(), many=True, slug_field='name')
    wormmeasurementkey = serializers.SlugRelatedField(queryset=Wormmeasurement.objects.all(), many=True, slug_field='name')
    wormwireframekey = serializers.SlugRelatedField(queryset=Wormwireframevideo.objects.all(), many=True, slug_field='name')
...
class PlateSerializer(serializers.ModelSerializer):
    #owner = serializers.SlugRelatedField(queryset=User.objects.all(), many=True, slug_field='name')
    experimenterkey = serializers.SlugRelatedField(queryset=Experimenter.objects.all(), many=True, slug_field='name')
    wormlistkey = serializers.SlugRelatedField(queryset=Wormlist.objects.all(), many=True, slug_field='name')
...
class PlatewireframevideoSerializer(serializers.ModelSerializer):
    #owner = serializers.SlugRelatedField(queryset=User.objects.all(), many=True, slug_field='name')
    platerawvideokey = serializers.SlugRelatedField(queryset=Platerawvideo.objects.all(), many=True, slug_field='name')
    cvalgorithmkey = serializers.SlugRelatedField(queryset=Computervisionalgorithm.objects.all(), many=True, slug_field='name')
...
class WormSerializer(serializers.ModelSerializer):
    #owner = serializers.SlugRelatedField(queryset=User.objects.all(), many=True, slug_field='name')
    strainkey = serializers.SlugRelatedField(queryset=Strain.objects.all(), many=True, slug_field='name')
...
class WormfeatureSerializer(serializers.ModelSerializer):
    #owner = serializers.SlugRelatedField(queryset=User.objects.all(), many=True, slug_field='name')
    typekey = serializers.SlugRelatedField(queryset=Type.objects.all(), many=True, slug_field='name')
    categorykey = serializers.SlugRelatedField(queryset=Category.objects.all(), many=True, slug_field='name')
    directionkey = serializers.SlugRelatedField(queryset=Direction.objects.all(), many=True, slug_field='name')
    aspectkey = serializers.SlugRelatedField(queryset=Aspect.objects.all(), many=True, slug_field='name')
    bodypartkey = serializers.SlugRelatedField(queryset=Bodypart.objects.all(), many=True, slug_field='name')
...
class WormlistSerializer(serializers.ModelSerializer):
    #owner = serializers.SlugRelatedField(queryset=User.objects.all(), many=True, slug_field='name')
    wormkey = serializers.SlugRelatedField(queryset=Worm.objects.all(), many=True, slug_field='name')
