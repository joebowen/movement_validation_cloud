...
class HistogramsperwormwireframeSerializer(serializers.ModelSerializer):
    #owner = serializers.PrimaryKeyRelatedField(queryset=User.objects.all())
    eventdirectionkey = serializers.PrimaryKeyRelatedField(queryset=Direction.objects.all())
    wormfeaturekey = serializers.PrimaryKeyRelatedField(queryset=Wormfeature.objects.all())
    wormwireframekey = serializers.PrimaryKeyRelatedField(queryset=Wormwireframevideo.objects.all())
...
class PlateSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = Plate
        fields = ('id', 'timestamp', 'sampletype', 'startdatetime', 'copyright', 'vulvaorientation', 'annotation', 'chemicals', 'food', 'illumination', 'temperature', 'tracker', 'agarside', 'gasconcentration', 'experimenterkey', 'wormlistkey' )
...
class PlaterawvideoSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = Platerawvideo
        fields = ('id', 'timestamp', 'platekey', 'videometadatakey', 'videofile')
